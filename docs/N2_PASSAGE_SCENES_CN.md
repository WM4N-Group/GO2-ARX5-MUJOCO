...
范围说明（2026-09-15）：本页记录发布于77abf08、由008a795继承的旧通道场景族与数据工具，实验数字保留原日期。默认0.005摩擦箱是旧通道基线，不是新0.4摩擦Hybrid PUSH或移动支撑流程的能力范围。当前项目任务和机器状态见 [主交接](AGENT_HANDOFF_CN.md)；先收敛新组合的物理失败与集成边界，再恢复几何候选和数据扩容。
