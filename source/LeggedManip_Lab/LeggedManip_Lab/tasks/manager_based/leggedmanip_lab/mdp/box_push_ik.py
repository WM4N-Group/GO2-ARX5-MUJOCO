...
class PushArmIK:
    def __init__(self, env, hold_legs_until_ready=False, lock_arm_on_contact=False):
        self.env = env
        ...
        self.controller = DifferentialIKController(
            DifferentialIKControllerCfg(command_type="position", use_relative_mode=False, ik_method="dls", ik_params={"lambda_val": 0.1}),
    ...
    def apply(self, actions):
        ...
        self.controller.set_command(push_hand_target(self.env), ee_quat=quaternion)
